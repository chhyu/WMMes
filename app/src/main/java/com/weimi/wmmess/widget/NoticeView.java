...
import com.weimi.wmmess.base.BeanNoticeView;
...
public class NoticeView extends TextSwitcher {
    ...
    private List<BeanNoticeView> mDataList = new ArrayList<>();
    ...
    public void start(List<BeanNoticeView> list) {
        mDataList = list;
    ...
    private void show(int index) {
        ...
        setText(Html.fromHtml(mDataList.get(mIndex).getNoticeTitle()));
    }
