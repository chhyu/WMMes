...
public class AddProcedureOutputActivity extends WMActivity<ProcedureOutputPresenter> implements View.OnClickListener, IAddProcedureOutputView {
    ...
    private static final int REQUEST_WORK_ORDER = 310;
    private static final int REQUEST_WORK_PROCEDURE = 311;
    private static final int REQUEST_WORK_CENTER = 312;
    private static final int REQUEST_DEVICE = 314;
    private static final int REQUEST_EMPLOYEE = 315;
    private WorkOrderListResbean workOrderListResbean;
    private WmMesWorkshopProcedureOutputRegister params;
    ...
    public int initLayout() {
        return R.layout.activity_add_procedure_output;
    }
    ...
    public void initData() {
        ...
        params = new WmMesWorkshopProcedureOutputRegister();
        String recordId = getIntent().getStringExtra(RECORD_ID);
        if (!StringUtils.isEmpty(recordId)) {
            presenter.getMesWorkshopProcedureOutputById(recordId);
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.rlWorkOrder:
                intent = new Intent(AddProcedureOutputActivity.this, ChooseWorkOrderActivity.class);
            ...
            case R.id.rlProcedure:
                ...
                intent = new Intent(AddProcedureOutputActivity.this, ChooseProcedureActivity.class);
            ...
            case R.id.rlWorkCenter:
                intent = new Intent(AddProcedureOutputActivity.this, ChooseWorkCenterActivity.class);
                startActivityForResult(intent, REQUEST_WORK_CENTER);
                break;
            case R.id.rlDeviceName:
                intent = new Intent(AddProcedureOutputActivity.this, ChooseDeviceActivity.class);
                startActivityForResult(intent, REQUEST_DEVICE);
                break;
            case R.id.rlEmployee:
                intent = new Intent(AddProcedureOutputActivity.this, ChooseEmployeeActivity.class);
            ...
            case R.id.btnConfirm:
                ...
                if (StringUtils.isEmpty(params.getRecordId())) {
                    presenter.checkDataAndInsertProcedureOut(params);
                } else {
                    presenter.updateProcedureOutput(params);
                }
                break;
            case R.id.btnCancel:
                finish();
    ...
    private void showChooseDateDialog(int timeType) {
        DatePickDialog dialog = new DatePickDialog(AddProcedureOutputActivity.this);
        //点击外部不消失
    ...
    @Override
    public void onGetProcedureDetailSuccess(ProcedureOutputDetailResbean bean) {
